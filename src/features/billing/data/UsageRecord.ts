...
import { UsageRecordInterface, ReportUsageInput } from "./usage-record.interface";

export class UsageRecord extends AbstractApiData implements UsageRecordInterface {
