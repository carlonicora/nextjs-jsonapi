...
export function PaymentMethodCard({ paymentMethod, onUpdate }: PaymentMethodCardProps) {
  ...
  const handleSetDefault = async () => {
    ...
    setLoading(true);
    try {
      await BillingService.setDefaultPaymentMethod({ paymentMethodId: paymentMethod.id });
  ...
  const handleRemove = async () => {
    ...
    setLoading(true);
    try {
      await BillingService.removePaymentMethod({ paymentMethodId: paymentMethod.id });
