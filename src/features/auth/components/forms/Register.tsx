        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardContent>
              ...
              {registrationMode === "waitlist" && inviteValidated && (isGoogleAuthEnabled() || isDiscordAuthEnabled()) && (
                <div className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    {isGoogleAuthEnabled() && (
                      <Link href={`${getApiUrl()}auth/google${inviteCode ? `?invite=${inviteCode}` : ""}`} className="flex w-full">
                        <Button className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-300" variant="outline" type="button">
                    ...
                    {isDiscordAuthEnabled() && (
                      <Link href={`${getApiUrl()}auth/discord${inviteCode ? `?invite=${inviteCode}` : ""}`} className="flex w-full">
